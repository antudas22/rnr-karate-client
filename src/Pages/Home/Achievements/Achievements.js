...
import ac0 from '../../../assets/achievements/ac0.jpg'
...
const Achievements = () => {
    ...
    <div className='flex justify-center'>
        ...
        <img src={ac0} className="w-full" alt='' />
        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            <a href="#slide13" className="btn btn-circle">❮</a>
            <a href="#slide2" className="btn btn-circle">❯</a>
        </div>
            <div className='glass absolute bottom-0 p-4'>
            <p className='hidden lg:block text-white'>RNR Gladiator International Karate Academy Belt exam ceremony and medalist from 2022. Chief guest: Dr. Selina Hayat Ivy. Honorable Mayor of Narayanganj City Corporation</p>
            </div>
        </div>
